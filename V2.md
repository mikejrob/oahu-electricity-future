...
- **Forced outages and the security criterion** — v1 derates no existing
  ...
  v2 does the same: unit-level outage draws (rates from the adequacy
...
- **Scheduled-maintenance timing on a solar-heavy grid** — v1 carries
  ...
  annual maintenance alongside the forced outages. v2 schedules
...
- **Kalaeloa's must-run floor lifted after 2033** — the model requires the
  ...
  structure — so v2 relaxes the floor from 2033 on. The floor applies
