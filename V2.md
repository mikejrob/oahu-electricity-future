...
- **Forced outages and the security criterion** — v1 derates no existing
  ...
  planning rule. Any criterion with teeth cuts against large units:
  reserves scale with the largest online shaft, and lumpy outage risk
  scales with unit size, both favoring modular fleets and batteries.
